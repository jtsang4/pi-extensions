...
Extensions retired from the published package live under [`archives/`](archives/);
they stay in the repository for reference and are not loaded by Pi or shipped
on npm. [better-compaction](archives/better-compaction/) was the first to move
there.
